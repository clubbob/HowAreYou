...
- 약관/개인정보: `https://오늘어때.com/terms`, `/privacy`
...
1. 혼자 사는 부모님 또는 자녀가 / 걱정될 때
2. 내가 혼자 사는데 / 연락할 보호자가 필요할 때
3. 떨어져 있는 가족 또는 지인의 / 안부가 궁금할 때

---

**ServiceSection** ("이렇게 안부를 전합니다"):
1. **간단하게 남깁니다** — 버튼 한 번으로 오늘의 안부를 기록합니다. 길게 쓰지 않아도 괜찮습니다.
2. **필요한 순간에만 안내합니다** — 기록을 하면 보호자에게 알림이 전달됩니다. 기록이 없을 때는 당일 저녁 7시에 안부 인사만, 8시(보호자 안내)에만 발송됩니다. 불필요한 알림은 보내지 않습니다.
3. **3일 이상 신호가 없을 때** — 3일 연속 기록이 없으면 보호자에게 알림이 전달됩니다. 조용하지만 놓치지 않는 구조입니다.
...
**배너**: "알림을 켜야 컨디션 기록 알림을 받을 수 있습니다." + [설정에서 켜기] 버튼
...
**배너**: "알림을 켜야 안부 확인 알림을 받을 수 있습니다." + [설정에서 켜기] 버튼
