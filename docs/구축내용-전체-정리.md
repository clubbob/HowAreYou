...
| **StatsSection** | "우리는 점점 혼자 살고 있습니다" - 350만/700만+/수십만 통계, "안부를 전하는 방식도 달라져야 합니다" |
...
- 빠른 링크: 회원관리, 1:1 문의, **서비스 개선**, 공지사항, 베타 1기 참여 리스트
...
- **URL**: `https://오늘어때.com/admin/service-feedback`
...
| `reportAdminFcmOpened` | 관리자 FCM 열람 보고 (Callable, waitlist lastFcmOpenedAt) |
...
| `waitlist` | 베타 대기 (lastFcmSentAt, lastFcmOpenedAt 포함) |
| `announcements` | 공지사항 |
| `inquiries` | 1:1 문의 |
...
| 관리자 FCM | 베타 대기 대상 선택 발송, 열람 시 reportAdminFcmOpened | waitlist 매칭 사용자 |
