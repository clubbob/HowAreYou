...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: '홈페이지에서 "1개월 무료 체험하기"를 클릭하면 안내 모달이 열립니다. "Android 앱 설치하기"로 Play Store에서 바로 설치할 수 있습니다. 베타 1기 1년 무료 혜택을 원하시면 "베타 1기 1년 무료 혜택 신청"에서 이름·휴대폰·이메일을 입력해 신청하세요. 신청 후 앱에서 동일 휴대폰 번호로 가입하면 1년 무료로 이용됩니다.',
  },
  {
    q: '무료 체험은 어떻게 되나요?',
