...
const FAQ_ITEMS = [
  ...
  {
    q: '알림은 몇 번 발송되나요?',
    a: '보호대상자에게는 매일 저녁 7시에 기록 안내 알림이 발송됩니다(이미 기록한 날은 제외). 보호자에게는 매일 저녁 8시에 당일 기록이 없는 경우에만 알림이 발송되며, 3일 이상 기록이 없을 경우 추가로 1회 안내됩니다. 불필요한 알림은 보내지 않으며, 기록이 없을 때에만 안내됩니다.',
  },
  {
    q: '보호자는 어떤 기록을 볼 수 있나요?',
    a: '보호대상자가 남긴 안부(컨디션) 기록만 확인할 수 있습니다.',
  },
  {
