...
2. 전화번호 입력: **010-1111-2222** (보호자) 또는 **010-3333-4444** (보호 대상자)
3. **인증 코드 전송** 클릭
...
- Firebase Console에서 **테스트 전화번호**가 다음으로 등록되어 있는지 확인:
  - 보호자: **+82 10-1111-2222**, 인증 코드 **111111**
  - 보호 대상자: **+82 10-3333-4444**, 인증 코드 **333333**
- 전화번호는 **010-1111-2222** 형식으로 입력해도 앱에서 **+821011112222**로 변환됨
- 자세한 설정 방법은 **docs/테스트-전화번호-설정.md** 참고
